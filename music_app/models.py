...
class Song(models.Model):
    ...
    tags = models.CharField(choices=tags, max_length=20, default='Love')
    genre = models.CharField(choices=genre, max_length=20, default='Album')
    language = models.CharField(choices=language, max_length=20, default='Telugu')
    year = models.CharField(choices=yearOfRelease, max_length=20, default='2024')
